...
class _TextInputWidgetState extends State<TextInputWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      prefixIcon: Icon(Icons.message), labelText: "Enter Product Name"
    ...
    Container(
      ...
      cursorColor: Colors.black,
      decoration: InputDecoration(
      prefixIcon: Icon(Icons.message), labelText: "Enter Product Brand"
    ),
    //onChanged: (text) => this.changeText(text),
    ),
    ),
    ...
    Container(
      ...
      cursorColor: Colors.black,
      decoration: InputDecoration(
      prefixIcon: Icon(Icons.message), labelText: "Enter Product Quantity"
    ),
    //onChanged: (text) => this.changeText(text),
    ),
    ),
    Container(
      ...
      cursorColor: Colors.black,
      decoration: InputDecoration(
      prefixIcon: Icon(Icons.message), labelText: "Use By Date"
    ),
    //onChanged: (text) => this.changeText(text),
    ),
    ),
...
class AddProduct extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold( 
      appBar: AppBar(
        title: const StyledBodyText('Add A Product'),
        backgroundColor: Colors.black,
        centerTitle: true,
      ...
      bottomNavigationBar: CommonFooterMenu(context).getFooterMenu(2),
